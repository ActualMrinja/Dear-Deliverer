...
itembuild.prototype.draw = function(index) {
    ...
    if (this.Type.split("Icon").length == 1&&(collision(chimneyfound[0], chimneyfound[1] + (80 / 3), 5, (gifload[13].height - 80) / 3, this.X - this.Image.width / 3 / 2, this.Y - this.Image.height / 3 / 2, this.Image.width / 3, this.Image.height / 3) || collision(chimneyfound[0] + gifload[13].width / 3 - 5, chimneyfound[1] + (80 / 3), 5, (gifload[13].height - 80) / 3, this.X - this.Image.width / 3 / 2, this.Y - this.Image.height / 3 / 2, this.Image.width / 3, this.Image.height / 3))) {
